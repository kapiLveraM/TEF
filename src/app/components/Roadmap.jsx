  ...
  return (
    ...
    >
      <div className="container xl:max-w-[1440px] 2xl:max-w-[1356px] mx-auto px-4 2xl:px-0 bg-black md:pt-[190px] pb-[92px] md:pb-[116px] relative">
            ...
            <div className=" mt-0">
              ...
              >
                ...
                <p className=" font-Inter text-white text-sm md:text-xl md:!leading-[24px] mt-2 md:mt-3">
                  Bewerben sie sich für eine der 6 Wohnungen wir werden sie
                  gerne kontaktieren{" "}
                </p>
                <div className=" mt-5 md:mt-7">
                  <button className="font-bold font-Inter text-white text-xl !leading-[24px]  py-3 px-5 bg-[#2A2A2A] border border-black hover:border-white transition-all duration-300 ease-out">
                    Kontakt
                  </button>
                </div>
              </div>
              ...
              >
                ...
                <p className="font-Inter text-white text-sm md:text-xl md:!leading-[24px] mt-2 md:mt-3">
                  Mit einer ihrer bank gbestäärtigten Bonits .... werden wir
        ...
        <div className="bg_liner absolute w-full h-[625px] md:h-[1000px] bottom-0 opacity-95 sm:opacity-100 left-0 pointer-events-none"></div>
      </div>
    </div>
  );
};
